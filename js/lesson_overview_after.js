jQuery(function ($) {
  ...
  function setDisplayMsg () {
    var msg = 'Would you like to show the lesson overview after the date range?'
    $('form + div').html(msg)
  }
    ...
    $.post(url, $(this).serialize(), function (data) {
      ...
      if (n === 0) {
        $('form + div').html(function () {
          ...
          var line2 = openDiv + 'After the date range, no student visited overview page.' + closeDiv
      ...
      if (n === m) {
        $('form + div').html(function () {
          ...
          var closeDiv = '</div>'
          var line1 = openDiv + course + closeDiv
          var line2 = openDiv + 'After the date range, ' + m + ' or 100%' + msg + closeDiv
      ...
      $('form + div').html(function () {
        ...
        var closeDiv = '</div>'
        var line1 = openDiv + course + closeDiv
        var line2 = openDiv + 'After the date range, ' + msg + closeDiv
